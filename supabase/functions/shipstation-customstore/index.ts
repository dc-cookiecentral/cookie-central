...
const PAGE_SIZE = 100;
const SELECT =
  '*, sales_rep:sales_reps!sales_rep_id ( email, full_name ), salesperson:user_profiles!salesperson_user_id ( email, full_name ), address:addresses!address_id ( * ), sample_shipment_items ( * )';
